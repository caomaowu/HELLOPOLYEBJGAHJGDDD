...
data class CopyTradingCreateRequest(
    ...
    val buyCycleEnabled: Boolean? = null,
    val buyCycleRunSeconds: Int? = null,
    val buyCyclePauseSeconds: Int? = null,
    ...
    val repeatAddCooldownEnabled: Boolean? = null,
...
data class CopyTradingDto(
    ...
    val buyCycleEnabled: Boolean = false,
    val buyCycleRunSeconds: Int? = null,
    val buyCyclePauseSeconds: Int? = null,
    val buyCycleAnchorStartedAt: Long? = null,
