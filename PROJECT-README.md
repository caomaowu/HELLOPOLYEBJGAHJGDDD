...
- `dev-scripts/`：开发环境脚本，包含初始化、启动、停止脚本（Windows / Linux）
- `prod-scripts/`：生产环境脚本，包含初始化、构建、启动、停止脚本
...
- [部署文档](docs/zh/DEPLOYMENT.md)
- [非 Docker 开发与部署方案](docs/zh/NON_DOCKER_DEPLOYMENT.md)
...
- [回测文档](docs/zh/backtest/README.md)
- [加密尾盘策略文档](docs/crypto-tail-strategy/README.md)
